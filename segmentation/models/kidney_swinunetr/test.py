...
if __name__ == '__main__':
    ...
    # Other paths
    prediction_save_path = '/hdd/yang/results/glomeruli_segmentation/SwinUNETR_results/fold2/validation'
    ...
    # Load model
    checkpoint_path = '/hdd/yang/results/glomeruli_segmentation/SwinUNETR_results/fold2/'
    model_name = 'swin-unetr_fold2.tar'
    ...
    if test_label_path is not None:
        ...
        #predict_without_label(net, test_list, metricer, transform, prediction_save_path)
