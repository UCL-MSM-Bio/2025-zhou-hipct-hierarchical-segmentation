...
from dataset.transforms import ZScoreNormalisation
...
if __name__ == '__main__':
    ...
    # Other paths
    prediction_save_path = '/hdd/yang/results/glomeruli_segmentation/VNet_results/fold2/validation/'
    ...
    # Load model
    checkpoint_path = '/hdd/yang/results/glomeruli_segmentation/VNet_results/fold2/'
    model_name = 'vnet_fold2.tar'
