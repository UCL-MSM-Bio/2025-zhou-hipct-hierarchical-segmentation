...
def processing_dataset(raw_data_path, nnunet_data_path, raw_data_seperate_json, train_des_folder, train_label_des_folder, test_des_folder):
    ...
    for i, cube_name in enumerate(test_data):
        ...
        # spacing file!
        save_json({'spacing': spacing}, os.path.join(test_des_folder, target_name + '.json'))
    ...
    gen_JSON(
        ...
        dataTs=test_data,
        lblTr=train_labels,
        save_path=os.path.join(nnunet_data_path, 'nnUNet_raw', 'Dataset001_Glomeruli')
    )
...
if __name__ == '__main__':
    ...
    raw_data_seperate_json = '/hdd/yang/data/kidney_seg/90_10/valid_seperate.json'
    train_des_folder = '/hdd/yang/data/kidney_seg_nnunet/nnUNet_raw/Dataset001_Glomeruli/imagesTr'
    train_label_des_folder = '/hdd/yang/data/kidney_seg_nnunet/nnUNet_raw/Dataset001_Glomeruli/labelsTr'
    test_des_folder = '/hdd/yang/data/kidney_seg_nnunet/nnUNet_raw/Dataset001_Glomeruli/imagesTs'
    processing_dataset(raw_data_path, nnunet_data_path, raw_data_seperate_json, train_des_folder, train_label_des_folder, test_des_folder)
